...
const steps = (values) => {
    return ([
        ...
        { title: 'Descarga de documento', content: <Step_4/> },
    ])
};
                ...
                {({ handleSubmit, values }) => (
                    ...
                    <Form layout="vertical" onFinish={handleSubmit} >
                        ...
                        <div
                            ...
                            {current < items.length -1   && (<Button type="primary" htmlType="submit" size='large'> Next </Button>)}
                            {current === items.length -1   && (<Button type="primary" htmlType="submit" onClick={() => message.success('Processing complete!')} size='large'> Done </Button>)}
                        </div>
                    </Form>
