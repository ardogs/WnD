...
import { DarkmodeSwitch, LanguageSelect } from "../../../dashboard/settings/components";
...
const optionsArray = (t, color) => {
    return [
        ...
        { key: 'companies', icon: <ShopFilled  style={{ color: color.cyan.backgroundColor }} />, label: <Link to="/companies">{t("ui.navigation.companies.title")}</Link> },
